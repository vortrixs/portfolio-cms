...
$article = (new Article(new DB))->read($id);
...
if (Input::exists()) {
    if (Token::check(Input::get('token'))) {
        ...
        if ($validation->passed()) {
            unset($article);
            $article = (new Article(new DB))->update($id,[
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
      ...
      <form action="" method="post">
        <label for="headline">Title:
          <input id="headline" name="headline" type="text" value="<?php echo $article->headline ?>">
        </label>
        <br>
        <label for="sub_headline">Sub title:
          <input id="sub_headline" name="sub_headline" type="text" value="<?php echo $article->sub_headline ?>">
        </label>
        <br>
        ...
        <label for="end_at">End date:
          <input id="end_at" name="end_at" value="<?php echo $article->end_at ?>" type="date">
        </label>
        <br>
