...
$menu = (new Navigation(new DB))->read($id);
...
if (Input::exists()) {
    if (Token::check(Input::get('token'))) {
        ...
        if ($validation->passed()) {
            unset($menu);
            $menu = (new Navigation(new DB))->update($id,[
...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
      <h1 class="page-header">Edit Menu Entry</h1>
        ...
        <table class="table table-striped">
          ...
          <tbody>
            ...
            <form action="" method="post">
              ...
              <td><input type="text" name="parent" value="<?php echo $menu->parent_id; ?>"></td>
              <td><input type="text" name="position" value="<?php echo $menu->position; ?>"></td>
              <td>
